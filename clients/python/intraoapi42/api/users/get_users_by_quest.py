...
from ...models.get_users_by_quest_filter import GetUsersByQuestFilter
from ...models.get_users_by_quest_range import GetUsersByQuestRange
...
def _get_kwargs(
    ...
    *,
    ...
    filter_: GetUsersByQuestFilter | Unset = UNSET,
    range_: GetUsersByQuestRange | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/quests/{quest_id}/users".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        quest_id (str):
        sort (str | Unset):
        filter_ (GetUsersByQuestFilter | Unset):
        range_ (GetUsersByQuestRange | Unset):
        per_page (int | Unset):
