...
from ...models.get_users_by_partnership_id_filter import GetUsersByPartnershipIdFilter
from ...models.get_users_by_partnership_id_range import GetUsersByPartnershipIdRange
...
def _get_kwargs(
    ...
    *,
    ...
    filter_: GetUsersByPartnershipIdFilter | Unset = UNSET,
    range_: GetUsersByPartnershipIdRange | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/partnerships/{partnership_id}/users".format(
            partnership_id=quote(str(partnership_id), safe=""),
        ),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        partnership_id (str):
        sort (str | Unset):
        filter_ (GetUsersByPartnershipIdFilter | Unset):
        range_ (GetUsersByPartnershipIdRange | Unset):
        per_page (int | Unset):
