...
from ...models.get_users_by_achievement_filter import GetUsersByAchievementFilter
from ...models.get_users_by_achievement_range import GetUsersByAchievementRange
...
def _get_kwargs(
    ...
    *,
    ...
    filter_: GetUsersByAchievementFilter | Unset = UNSET,
    range_: GetUsersByAchievementRange | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/achievements/{achievement_id}/users".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        achievement_id (str):
        sort (str | Unset):
        filter_ (GetUsersByAchievementFilter | Unset):
        range_ (GetUsersByAchievementRange | Unset):
        per_page (int | Unset):
