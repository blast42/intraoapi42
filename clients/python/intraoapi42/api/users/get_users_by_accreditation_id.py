...
from ...models.get_users_by_accreditation_id_filter import GetUsersByAccreditationIdFilter
from ...models.get_users_by_accreditation_id_range import GetUsersByAccreditationIdRange
...
def _get_kwargs(
    ...
    *,
    ...
    filter_: GetUsersByAccreditationIdFilter | Unset = UNSET,
    range_: GetUsersByAccreditationIdRange | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/accreditations/{accreditation_id}/users".format(
            accreditation_id=quote(str(accreditation_id), safe=""),
        ),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        accreditation_id (str):
        sort (str | Unset):
        filter_ (GetUsersByAccreditationIdFilter | Unset):
        range_ (GetUsersByAccreditationIdRange | Unset):
        per_page (int | Unset):
