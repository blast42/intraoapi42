...
from ...models.get_users_by_title_filter import GetUsersByTitleFilter
from ...models.get_users_by_title_range import GetUsersByTitleRange
...
def _get_kwargs(
    ...
    *,
    ...
    filter_: GetUsersByTitleFilter | Unset = UNSET,
    range_: GetUsersByTitleRange | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/titles/{title_id}/users".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        title_id (str):
        sort (str | Unset):
        filter_ (GetUsersByTitleFilter | Unset):
        range_ (GetUsersByTitleRange | Unset):
        per_page (int | Unset):
