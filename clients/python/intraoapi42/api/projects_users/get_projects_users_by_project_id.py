...
from ...models.get_projects_users_by_project_id_filter import GetProjectsUsersByProjectIdFilter
from ...models.get_projects_users_by_project_id_range import GetProjectsUsersByProjectIdRange
...
def _get_kwargs(
    project_id: str,
    *,
    filter_: GetProjectsUsersByProjectIdFilter | Unset = UNSET,
    range_: GetProjectsUsersByProjectIdRange | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/projects/{project_id}/projects_users".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        project_id (str):
        filter_ (GetProjectsUsersByProjectIdFilter | Unset):
        range_ (GetProjectsUsersByProjectIdRange | Unset):
        page (int | Unset):
        per_page (int | Unset):
