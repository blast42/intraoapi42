...
def _get_kwargs(
    ...
    *,
    ...
    filter_: GetInternshipsByUserIdFilter | Unset = UNSET,
    range_: GetInternshipsByUserIdRange | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/users/{user_id}/internships".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        user_id (str):
        sort (str | Unset):
        filter_ (GetInternshipsByUserIdFilter | Unset):
        range_ (GetInternshipsByUserIdRange | Unset):
        page (int | Unset):
        per_page (int | Unset):
