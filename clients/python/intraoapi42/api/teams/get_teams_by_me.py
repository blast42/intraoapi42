...
from ...models.get_teams_by_me_filter import GetTeamsByMeFilter
from ...models.get_teams_by_me_range import GetTeamsByMeRange
...
def _get_kwargs(
    *,
    ...
    filter_: GetTeamsByMeFilter | Unset = UNSET,
    range_: GetTeamsByMeRange | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        sort (str | Unset):
        filter_ (GetTeamsByMeFilter | Unset):
        range_ (GetTeamsByMeRange | Unset):
        page (int | Unset):
        per_page (int | Unset):
