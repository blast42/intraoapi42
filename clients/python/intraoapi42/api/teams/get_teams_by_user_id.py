...
from ...models.get_teams_by_user_id_filter import GetTeamsByUserIdFilter
from ...models.get_teams_by_user_id_range import GetTeamsByUserIdRange
...
def _get_kwargs(
    ...
    *,
    ...
    filter_: GetTeamsByUserIdFilter | Unset = UNSET,
    range_: GetTeamsByUserIdRange | Unset = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        user_id (str):
        sort (str | Unset):
        filter_ (GetTeamsByUserIdFilter | Unset):
        range_ (GetTeamsByUserIdRange | Unset):
        page (int | Unset):
        per_page (int | Unset):
