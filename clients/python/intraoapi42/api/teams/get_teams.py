...
from ...models.get_teams_filter import GetTeamsFilter
from ...models.get_teams_range import GetTeamsRange
...
def _get_kwargs(
    *,
    ...
    filter_: GetTeamsFilter | Unset = UNSET,
    range_: GetTeamsRange | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        sort (str | Unset):
        filter_ (GetTeamsFilter | Unset):
        range_ (GetTeamsRange | Unset):
        page (int | Unset):
        per_page (int | Unset):
