...
from ...models.get_teams_by_user_id_and_project_id_filter import GetTeamsByUserIdAndProjectIdFilter
from ...models.get_teams_by_user_id_and_project_id_range import GetTeamsByUserIdAndProjectIdRange
...
def _get_kwargs(
    ...
    *,
    ...
    filter_: GetTeamsByUserIdAndProjectIdFilter | Unset = UNSET,
    range_: GetTeamsByUserIdAndProjectIdRange | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/users/{user_id}/projects/{project_id}/teams".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        project_id (str):
        sort (str | Unset):
        filter_ (GetTeamsByUserIdAndProjectIdFilter | Unset):
        range_ (GetTeamsByUserIdAndProjectIdRange | Unset):
        page (int | Unset):
        per_page (int | Unset):
