...
from ...models.get_teams_by_project_session_id_filter import GetTeamsByProjectSessionIdFilter
from ...models.get_teams_by_project_session_id_range import GetTeamsByProjectSessionIdRange
...
def _get_kwargs(
    ...
    *,
    ...
    filter_: GetTeamsByProjectSessionIdFilter | Unset = UNSET,
    range_: GetTeamsByProjectSessionIdRange | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/project_sessions/{project_session_id}/teams".format(
            project_session_id=quote(str(project_session_id), safe=""),
        ),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        project_session_id (str):
        sort (str | Unset):
        filter_ (GetTeamsByProjectSessionIdFilter | Unset):
        range_ (GetTeamsByProjectSessionIdRange | Unset):
        page (int | Unset):
        per_page (int | Unset):
