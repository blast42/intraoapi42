...
T = TypeVar("T", bound="ProjectUserCreate")
...
class ProjectUserCreate:
    ...
    Attributes:
        ...
        user_id (int): The user id. Must be unique in the scope of a given project.
        ...
        status (None | str | Unset): The status. Default: 'unknown'.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        project_user_create.additional_properties = d
        return project_user_create
