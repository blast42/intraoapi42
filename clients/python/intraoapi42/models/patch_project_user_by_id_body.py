...
T = TypeVar("T", bound="PatchProjectUserByIdBody")


@_attrs_define
class PatchProjectUserByIdBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_project_user_by_id_body = cls(
            projects_user=projects_user,
        )

        patch_project_user_by_id_body.additional_properties = d
        return patch_project_user_by_id_body
